...
const Estate_Details = () => {
    ...
    const {image,estate_title,segment_name,description, price,status,area, location,facilities,rating} = currentEstate
    return (
        <div className="container mx-auto px-8 md:px-0 mt-12 mb-10">
            <div className="grid grid-cols-1 gap-8 md:gap-24 md:grid-cols-2">
                ...
                <div className="space-y-5">
                    ...
                    <hr />
                    <h4 className="text-[#131313CF] ws text-xl">category : {segment_name}</h4>
                    <hr />

                    <h2 className="text-[#131313CF] font-bold pp">Description :  <span className="text-gray-600 pp font-semibold"> {description} </span>
                    
                    </h2>

                    <div className="flex gap-8">
                        <span className="text-black pp font-bold">Facilities :</span>
                        <h3 className="text-gray-600 text-lg pp font-semibold"> {facilities[0]} </h3>
                        <h3 className="text-gray-600 text-lg pp font-semibold"> {facilities[1]} </h3>
                        <h3 className="text-gray-600 text-lg pp font-semibold"> {facilities[2]} </h3>
